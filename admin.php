<html lang="en">
	...
	<head>
		...
		<link href="public_html/css/jasny-bootstrap.min.css" rel="stylesheet">
    	...
    	<link href="public_html/css/admin.css" rel="stylesheet">
	...
	<body>
		...
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tbody id="AppBody" data-link="row" class="rowlink">
				</tbody>
			</table>
		</div>
		<div class>
		...
		<script src="public_html/js/jasny-bootstrap.min.js" type="text/javascript"></script>
