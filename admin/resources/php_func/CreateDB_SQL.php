...
function populateTables(){
	$statement = array(
		"INSERT INTO `schools` (`school_id`, `name`,`school_name`,`school_is_active`) VALUES
		(NULL, 'Southern Connecticut State University','Southern Connecticut State University', '1'),
		(NULL, 'University of New Haven','University of New Haven', '1'),
		(NULL, 'Yale University','Yale University', '1'),
		(NULL, 'Quinnipiac University','Quinnipiac University', '1'),
		(NULL, 'University of Connecticut','University of Connecticut', '1')
		",
		...
		",
		"INSERT INTO `states` (`state_id`, `name`,`state_name`) VALUES
		(NULL, 'Alabama', 'Alabama'),
		(NULL, 'Alaska', 'Alaska'),
		(NULL, 'Arizona', 'Arizona'),
		(NULL, 'Arkansas', 'Arkansas'),
		(NULL, 'California', 'California'),
		(NULL, 'Colorado', 'Colorado'),
		(NULL, 'Connecticut', 'Connecticut'),
		(NULL, 'Delaware', 'Delaware'),
		(NULL, 'District of Columbia', 'District of Columbia'),
		(NULL, 'Florida', 'Florida'),
		(NULL, 'Georgia', 'Georgia'),
		(NULL, 'Hawaii', 'Hawaii'),
		(NULL, 'Idaho', 'Idaho'),
		(NULL, 'Illinois', 'Illinois'),
		(NULL, 'Indiana', 'Indiana'),
		(NULL, 'Iowa', 'Iowa'),
		(NULL, 'Kansas', 'Kansas'),
		(NULL, 'Kentucky', 'Kentucky'),
		(NULL, 'Louisiana', 'Louisiana'),
		(NULL, 'Maine', 'Maine'),
		(NULL, 'Maryland', 'Maryland'),
		(NULL, 'Massachusetts', 'Massachusetts'),
		(NULL, 'Michigan', 'Michigan'),
		(NULL, 'Minnesota', 'Minnesota'),
		(NULL, 'Mississippi', 'Mississippi'),
		(NULL, 'Missouri', 'Missouri'),
		(NULL, 'Montana', 'Montana'),
		(NULL, 'Nebraska', 'Nebraska'),
		(NULL, 'Nevada', 'Nevada'),
		(NULL, 'New Hampshire', 'New Hampshire'),
		(NULL, 'New Jersey', 'New Jersey'),
		(NULL, 'New Mexico', 'New Mexico'),
		(NULL, 'New York', 'New York'),
		(NULL, 'North Carolina', 'North Carolina'),
		(NULL, 'North Dakota', 'North Dakota'),
		(NULL, 'Ohio', 'Ohio'),
		(NULL, 'Oklahoma', 'Oklahoma'),
		(NULL, 'Oregon', 'Oregon'),
		(NULL, 'Pennsylvania', 'Pennsylvania'),
		(NULL, 'Rhode Island', 'Rhode Island'),
		(NULL, 'South Carolina', 'South Carolina'),
		(NULL, 'South Dakota', 'South Dakota'),
		(NULL, 'Tennessee', 'Tennessee'),
		(NULL, 'Texas', 'Texas'),
		(NULL, 'Utah', 'Utah'),
		(NULL, 'Vermont', 'Vermont'),
		(NULL, 'Virginia', 'Virginia'),
		(NULL, 'Washington', 'Washington'),
		(NULL, 'West Virginia', 'West Virginia'),
		(NULL, 'Wisconsin', 'Wisconsin'),
		(NULL, 'Wyoming', 'Wyoming')
		",
		...
		(NULL, 'school_name', NULL, 'Please list your most recent educational institution, your major, and the date of your graduation (or anticipated graduation).', 'Select School', 'School', '2', '1', 'schools', '1', '1', 'applicants'),
		(NULL, 'major', NULL, NULL, NULL, 'Major', '2', '1', NULL, '1', '1', 'applicants'),
		(NULL, 'graduation_date', NULL, 'Month', 'Year', 'Graduation Date', '2', '1', NULL, '1', '1', 'applicants'),
		...
		(NULL, 'state_name', NULL, NULL, NULL, 'State', '2', '7', 'states', '1', '1', 'applicants'),
